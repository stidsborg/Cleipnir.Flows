...
public class SubscribeToFlowTests
{
    ...
    {
        public static RoutingInfo Route(Message msg) => ResilientFunctions.Domain.Route.To(msg.Route);
    ...
    {
        public static RoutingInfo Route(Message msg) => ResilientFunctions.Domain.Route.Using(msg.Route);
